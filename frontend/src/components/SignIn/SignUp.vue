<template>
    ...
    <div class="sign-up">
        <div style="font-size:150%; border:15%;">회 원 가 입</div><br>


        <div style="position: relative; left: -115px;">I D :</div>
        <button v-on:click="idCheck" id="idCheckClear" style="position: relative; right: -275px; border: 1px solid black; width: 75pt; height: 35pt; visibility:visible;">중복 확인</button>
        <img src="../../assets/loginComponentIMG/check.png" id="idClear" style="width:1%; visibility:hidden; position: relative; right: -205px;">
        <input type="text" id="id" name="uid" v-model="user.userid" placeholder="ID를 입력해주세요!" style="position: relative; left: -77px;"><br><br>


        <div style="position: relative; left: -97px;">N A M E : <br></div>
        <img src="../../assets/loginComponentIMG/check.png" id="nameClear" style="width:1%; visibility:hidden; position: relative; right: -367px;">
        <input type="text" value="*한글만 입력해 주세요." id="nameFalse" style="width:20%; position: relative; right: -315px; visibility:visible; font-weight: bold; border: 0px;">
        <input type="text" id="name" v-model="user.name" @keyup="nameCheck" placeholder="이름을 입력해주세요!" style="position: relative; left: -139px;"><br><br>


        <div style="position: relative; left: -115px;">P W : <br></div>
        <img src="../../assets/loginComponentIMG/check.png" id="pwClear" style="width:1%; visibility:hidden; position: relative; right: -509px;">
        <input type="text" value="*비밀번호는 영문,숫자,특수 문자 조합 4~15이내로 입력해주세요." id="pwFalse" style="width:45%; position: relative; right: -455px; visibility:visible; font-weight: bold; border: 0px;">
        <input type="password" id="pw" name="upw" v-model="user.password" @keyup="pwCheck" style="position: relative; left: -279px;" placeholder="PW를입력해주세요!"><br><br>


        <div style="position: relative; left: -77px;">C H E C K P W : <br></div>
        <input type="password" id="pwcheck" style="position: relative; left: -23px;" @keyup="repwCheck" placeholder="PW를 다시 입력해주세요!"><br><br>
        ...
        <br>
<button v-on:click="signUp" id="allClear" style="border: 1px solid black; width: 67pt; height: 35pt;">가입하기</button>
